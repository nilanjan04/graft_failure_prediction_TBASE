# =============================================================================
# Please uncomment and execute the following to install the packages below before execution
# =============================================================================
...
# =============================================================================
# restart the kernel after installing the above packages if you are using Spyder (Anaconda)
# =============================================================================
...
# =============================================================================
# Visualising the distribution of the dataset pre imputation
# =============================================================================
#This will save images of each feature distribution
...
temp_features.describe().transpose().join(df_summary.columns_stats.transpose()).to_csv(r'T:\tbase\short\feature_stats.csv') #Please change the path accordingly
...
feature_distribution_failure.describe().transpose().join(df_summary_distribution_failure.columns_stats.transpose()).to_csv(r'T:\tbase\short\feature_stats_failure.csv') #Please change the path accordingly
#Success class
...
feature_distribution_success.describe().transpose().join(df_summary_distribution_success.columns_stats.transpose()).to_csv(r'T:\tbase\short\feature_stats_success.csv') #Please change the path accordingly
...
# =============================================================================
# #Remove features with more than 20% missing data - uncomment if desired
# =============================================================================
...
feature_distribution_failure.describe().transpose().join(df_summary_failure.columns_stats.transpose()).to_csv(r'T:\tbase\short\high_entropy_feature_stats_failure.csv') #Please change the path accordingly
#Success class
feature_distribution_success = temp_features.loc[temp_features['Shortterm_TransplantOutcome'] == 0]
df_summary_success = DataFrameSummary(feature_distribution_success)
feature_distribution_success.describe().transpose().join(df_summary_success.columns_stats.transpose()).to_csv(r'T:\tbase\short\high_entropy_feature_stats_success.csv') #Please change the path accordingly   
    
# =============================================================================
# #Remove rows that contain null values - uncomment if desired    
# =============================================================================
...
# =============================================================================
# #Feature correlation - Drop highly correlated features - uncomment if desired
# =============================================================================
...
# =============================================================================
# #Keeping TransplantationID and PatientID in test data for error analysis later
# =============================================================================
...
# =============================================================================
# Visualising the distribution of the dataset post imputation
# =============================================================================
import seaborn as sns
import matplotlib.pyplot as plt
sns.set(rc={'figure.figsize':(15,12)})
...
# =============================================================================
# #Keeping TransplantationID in test data for error analysis later
# =============================================================================
...
df_predictions.loc[df_predictions_proba['prediction_proba'] >= 0.15, ['prediction']] = 1
df_predictions.loc[df_predictions_proba['prediction_proba'] < 0.15, ['prediction']] = 0
...
df_error_analysis.to_csv(r'T:\tbase\short\Qualitative_res.csv') #Please change the path accordingly
#
# =============================================================================
