...
select  p.PatientID ,
		...
		, case when datediff(yyyy,p.Datum_erste_Dialyse,t.Datum) < 0 then NULL else datediff(yyyy,p.Datum_erste_Dialyse,t.Datum) end as N_YearsBetweenTransplantationAndFirstDialysis
		--Patient diagnoses:
		...
		--Medications
		, case when med.Medik_A02B > 0 then Medik_A02B else NULL end as N_Medik_A02B
		, case when med.Medik_A11C > 0 then Medik_A11C else NULL end as N_Medik_A11C
		, case when med.Medik_B03X > 0 then Medik_B03X else NULL end as N_Medik_B03X
		, case when med.Medik_C03C > 0 then Medik_C03C else NULL end as N_Medik_C03C
		, case when med.Medik_C07A > 0 then Medik_C07A else NULL end as N_Medik_C07A
		, case when med.Medik_C08C > 0 then Medik_C08C else NULL end as N_Medik_C08C
		, case when med.Medik_H02AB > 0 then Medik_H02AB else NULL end as N_Medik_H02AB
		, case when med.Medik_L04AA > 0 then Medik_L04AA else NULL end as N_Medik_L04AA
		--Verlauf
		...
		, Banff15_6  as O_Banff15_6
		 --Label: Short-term
		 --Deaths and transplant failure between 12 and 18 months after transplantation are considered as transplant failure; Everything else as success; 1 month = 30.436 days: 18 months = 547.86 days
		...
		, case when datediff(dd,t.datum,t.TPV_Datum ) < (730) or datediff(dd,t.datum,p.Todesdatum ) < (730) then 1 else 0 end as Shortterm_TransplantOutcome_12months -- 0: Success; 1: Transplant Failure
	    --, case when datediff(dd, t.datum, t.TPV_Datum) between 0 and 181 then 
	    --		(case when t.TPV_Datum is null then 0 else 1 end) 
	    --		else 0 end as Shortterm_TransplantOutcome -- 0: Success; 1: Transplant Failure  
		--Label: Long-term
...
left join (
			 select a.PatientID
 		,AVG (case when datediff(dd,a.Datum,b.datum) between 0 and 180 then a.Blutdruck_systolisch end) as Blutdruck_systolisch_post_6_months_avg
 		,AVG (case when datediff(dd,a.Datum,b.datum) between 0 and 180 then a.Blutdruck_diastolisch end) as Blutdruck_diastolisch_post_6_months_avg
 		,AVG (case when datediff(dd,a.Datum,b.datum) between 0 and 180 then a.Urinvolumen end) as Urinvolumen_post_6_months_avg
 		,AVG (case when datediff(dd,a.Datum,b.datum) between 0 and 180 then a.Herzfrequenz end) as Herzfrequenz_post_6_months_avg
 from dbo.Verlauf a left join dbo.Transplantation b on a.PatientID = b.PatientID 
where year(b.Datum )>= 2004 --and a.PatientID = 346 --and a.Datum > b.Datum 
group by a.PatientID 
			) verlauf
			on p.PatientID = verlauf.PatientID
left join (
			SELECT --PatientID 
					TransplantationID 
					--, Datum  
...
left join ( 
		select TransplantationID
			...
			join  (SELECT 'A01AA51' as ATC, 'Natriumfluorid, Kombinationen' as BezKorrektur, 'A01A - Stomatologika (0)' as Untergruppe, '' as Dokumentation UNION ALL
					...
					SELECT 'L04AD01' as ATC, 'Ciclosporin' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'CNI CsA' as Dokumentation UNION ALL
					SELECT 'L04AA02' as ATC, 'Muromonab-CD3' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'OKT3' as Dokumentation UNION ALL
					SELECT 'L04AA03' as ATC, 'Antilymphozytäres Immunglobulin' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'ALG' as Dokumentation UNION ALL
					SELECT 'L04AA04' as ATC, 'Antithymozytäres Immunglobulin' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'ATG' as Dokumentation UNION ALL
					SELECT 'L04AD02' as ATC, 'Tacrolimus' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'CNI Tac' as Dokumentation UNION ALL
					SELECT 'L04AA06' as ATC, 'Mycophenolat' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					SELECT 'L04AA06' as ATC, 'Mycophenolatmofetil' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					SELECT 'L04AA06' as ATC, 'Mycophenolatnatrium' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					SELECT 'L04AA08' as ATC, 'Daclizumab' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'Ind Zenapax' as Dokumentation UNION ALL
					SELECT 'L04AA09' as ATC, 'Basiliximab' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'Ind Simulect' as Dokumentation UNION ALL
					SELECT 'L04AA10' as ATC, 'Sirolimus' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'mTOR Sirolimus' as Dokumentation UNION ALL
					SELECT 'L04AA13' as ATC, 'Leflunomid' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'Phase I/II/III' as Dokumentation UNION ALL
					SELECT 'L04AA18' as ATC, 'Everolimus (pc)' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'mTOR Everolimus' as Dokumentation UNION ALL
					SELECT 'L04AA06' as ATC, 'Mycophenolatmofetil (pc)' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					SELECT 'L04AA18' as ATC, 'Everolimus' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'mTOR Everolimus' as Dokumentation UNION ALL
					...
					SELECT 'L04AD01' as ATC, 'Ciclosporin A' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'CNI CsA' as Dokumentation UNION ALL
					SELECT 'L04AD01' as ATC, 'CyA' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'CNI CsA' as Dokumentation UNION ALL
					SELECT 'L04AD01' as ATC, 'Cyclosporin A' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'CNI CsA' as Dokumentation UNION ALL
					SELECT 'L04AD01' as ATC, 'Cyclosporin' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'CNI CsA' as Dokumentation UNION ALL
					...
					SELECT 'J01EE01' as ATC, 'Co-trimoxazol 960 mg' as BezKorrektur, 'J01E Trimethoprim/Sulfonamide' as Untergruppe, 'Beeinflussung Nierenfunktion' as Dokumentation UNION ALL
					SELECT 'L04AD02' as ATC, 'Tacrolismus' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'CNI Tac' as Dokumentation UNION ALL
					...
					SELECT 'L04AA06' as ATC, 'Mycophenolat Natrium' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					SELECT 'L04AA06' as ATC, 'Mycophenolant-Sodium' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					SELECT 'L04AA06' as ATC, 'Mycophenolat 360' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					SELECT 'L04AA06' as ATC, 'Myfortic' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					SELECT 'L04AA06' as ATC, 'Mycophenolsäure' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					SELECT 'L04AA06' as ATC, 'mycophenolsäure' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					SELECT 'L04AA06' as ATC, 'MPA' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					SELECT 'L04AA06' as ATC, 'Mycophenolat mofetil' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					...
					SELECT 'L04AA04' as ATC, 'Antithymozytenglobulin' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'ATG' as Dokumentation UNION ALL
					...
					SELECT 'L04AA06' as ATC, 'Mycophenolat-Natrium' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					SELECT 'L04AA06' as ATC, 'Mycophenolat-Na' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					...
					SELECT 'L04AA18' as ATC, 'RAD 201 Tabletten' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'mTOR Everolimus' as Dokumentation UNION ALL
					...
					SELECT 'L04AA06' as ATC, 'Mycophenolatnatrium (pc)' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'MPA' as Dokumentation UNION ALL
					...
					SELECT 'L04AA03' as ATC, 'Anti-Humanlymphozyten-Immunglobulin vom Pferd' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'ALG' as Dokumentation UNION ALL
					SELECT 'L04AA04' as ATC, 'Anti-Human-T-Lymphozyten-Immunglobuline von Kaninchen' as BezKorrektur, 'L04AA - Selektive Immunsuppressiva' as Untergruppe, 'ATG' as Dokumentation UNION ALL
					SELECT 'L04AA21' as ATC, 'Efalizumab' as BezKorrektur, '' as Untergruppe, '' as Dokumentation UNION ALL
					SELECT 'L04AA23' as ATC, 'Natalizumab' as BezKorrektur, '' as Untergruppe, '' as Dokumentation UNION ALL
					SELECT 'L04AA24' as ATC, 'Abatacept' as BezKorrektur, '' as Untergruppe, '' as Dokumentation UNION ALL
...
where year(t.datum) >= 2004 
	...
	--error analysis with Marcel
	and p.PatientID != 7333 --no transplant failure (of second TX), but death after surgery
	and p.PatientID != 3225 --sudden death
	and p.PatientID != 12093 --discharge summary: cardiac problems
	and p.PatientID != 11622 --apoplex